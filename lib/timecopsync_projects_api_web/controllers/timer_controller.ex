    ...
    %{
      Timer: swagger_schema do
        ...
        properties do
          ...
          end_time :string, "End time of the timer in UTC format, a timer cannot end before it started. If not provided, timer is still running"
      ...
      TimerInput: swagger_schema do
        ...
        end), "Timer object", required: true
...
#              per_page :integer, "Number of projects per page"
      ...
      TimerResponse: swagger_schema do
